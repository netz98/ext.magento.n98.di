...
class Magento_Framework_ObjectManager_Config_Mapper_DomTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \Magento_Framework_ObjectManager_Config_Mapper_Dom
     */
    protected $_mapper;
    ...
    {
        $argumentParser = $this->getMock('\Magento_Framework_ObjectManager_Config_Mapper_ArgumentParser');
        ...
        $booleanUtils = $this->getMock('\Magento_Framework_Stdlib_BooleanUtils');
        ...
        $this->argumentInterpreter = $this->getMock('Magento_Framework_Data_Argument_InterpreterInterface');
        ...
        $this->_mapper = new \Magento_Framework_ObjectManager_Config_Mapper_Dom($this->argumentInterpreter, $booleanUtils, $argumentParser);
    }
