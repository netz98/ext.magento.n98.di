 ...
 */
class Magento_Framework_Config_Dom_ArrayNodeConfig
{
    /**
     * @var Magento_Framework_Config_Dom_NodePathMatcher
     */
    ...
    public function __construct(
        Magento_Framework_Config_Dom_NodePathMatcher $nodePathMatcher,
