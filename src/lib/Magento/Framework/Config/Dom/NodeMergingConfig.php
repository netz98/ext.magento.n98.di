 ...
 */
class Magento_Framework_Config_Dom_NodeMergingConfig
{
    /**
     * @var NodePathMatcher
     */
    ...
    /**
     * @param Magento_Framework_Config_Dom_NodePathMatcher $nodePathMatcher
     * @param array $idAttributes
     */
    public function __construct(Magento_Framework_Config_Dom_NodePathMatcher $nodePathMatcher, array $idAttributes)
    {
