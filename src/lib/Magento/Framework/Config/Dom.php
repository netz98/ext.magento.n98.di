 ...
 */
class Magento_Framework_Config_Dom
{
    /**
    ...
    /**
     * @var Magento_Framework_Config_Dom_NodeMergingConfig
     */
    ...
    public function __construct(
        ...
        $this->_nodeMergingConfig = new Magento_Framework_Config_Dom_NodeMergingConfig(
            new Magento_Framework_Config_Dom_NodePathMatcher(),
            $idAttributes
        );
     ...
     * @throws Magento_Framework_Exception An exception is possible if original document contains multiple nodes for identifier
    ...
    protected function _getMatchedNode($nodePath)
    {
        ...
        if ($matchedNodes->length > 1) {
            throw new \Magento_Framework_Exception("More than one node matching the query: {$nodePath}");
     ...
     * @param string $xml
     * @return \DOMDocument
     * @throws \Magento_Framework_Config_Dom_ValidationException
     */
    protected function _initDom($xml)
    {
        ...
        if ($this->_schemaFile) {
            ...
            if (count($errors)) {
                throw new \Magento_Framework_Config_Dom_ValidationException(implode("\n", $errors));
            }
        }
        return $dom;
    }
