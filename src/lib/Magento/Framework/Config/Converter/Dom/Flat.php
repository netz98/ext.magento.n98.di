 ...
 */
class Magento_Framework_Config_Converter_Dom_Flat
{
    /**
     * @var Magento_Framework_Config_Dom_ArrayNodeConfig
     */
     ...
     * Constructor
     *
     * @param Magento_Framework_Config_Dom_ArrayNodeConfig $arrayNodeConfig
     */
    public function __construct(Magento_Framework_Config_Dom_ArrayNodeConfig $arrayNodeConfig)
    {
