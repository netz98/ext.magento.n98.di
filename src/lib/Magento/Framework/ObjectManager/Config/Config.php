 ...
 */
class Magento_Framework_ObjectManager_Config_Config
    implements Magento_Framework_ObjectManager_Config
{
    /**
     * Config cache
     *
     * @var Magento_Framework_ObjectManager_ConfigCache
     */
    protected $_cache;
    ...
    /**
     * @param \Magento_Framework_ObjectManager_Relations $relations
     * @param \Magento_Framework_ObjectManager_Definition $definitions
     */
    public function __construct(
        Magento_Framework_ObjectManager_Relations $relations = null,
     ...
     * @return void
     */
    public function setRelations(Magento_Framework_ObjectManager_Relations $relations)
    {
        $this->_relations = $relations;
    }
     ...
     * Set cache instance
     *
     * @param Magento_Framework_ObjectManager_ConfigCache $cache
     * @return void
     */
    public function setCache(Magento_Framework_ObjectManager_ConfigCache $cache)
    {
        $this->_cache = $cache;
    }
