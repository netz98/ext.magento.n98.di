 ...
 */
class Magento_Framework_Data_Argument_Interpreter_Composite
    implements Magento_Framework_Data_Argument_InterpreterInterface
{
    /**
     * Format: array('<name>' => <instance>, ...)
     *
     * @var Magento_Framework_Data_Argument_InterpreterInterface[]
     */
    ...
    /**
     * @param Magento_Framework_Data_Argument_InterpreterInterface[] $interpreters
    ...
    public function __construct(array $interpreters, $discriminator)
    {
        foreach ($interpreters as $interpreterName => $interpreterInstance) {
            if (!$interpreterInstance instanceof Magento_Framework_Data_Argument_InterpreterInterface) {
     ...
     *
     * @param string $name
     * @param Magento_Framework_Data_Argument_InterpreterInterface $instance
     * @return void
     * @throws \InvalidArgumentException
     */
    public function addInterpreter($name, Magento_Framework_Data_Argument_InterpreterInterface $instance)
    {
     ...
     *
     * @param string $name
     * @return Magento_Framework_Data_Argument_InterpreterInterface
     * @throws \InvalidArgumentException
     */
